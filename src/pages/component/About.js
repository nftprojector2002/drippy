...
export default function About() {
  ...
  return (
      <div id="about" className="w-full bg-cover bg-no-repeat bg-center text-justify" style={{backgroundImage: 'url("/asset/gradient backgrounds/blue-turquoise gradient_2.png")'}}>
        <img src="/animated/dripping/Dripping-Border_yellow.gif" alt="logo" className="absolute z-50 w-full" />
        <img src="/animated/Drippy-Smiles-Title.gif" alt="drippy title" className="w-full pt-16 md:pt-40 " />
        <p className="text-xl text-yellow-200 font-macaria px-10 pt-32 md:text-2xl md:pt-44 md:pb-32 md:px-36 " >
